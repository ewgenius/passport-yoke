...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || 'http://id.yoke.kz/oauth2/authorize';
    options.tokenURL = options.tokenURL || 'http://id.yoke.kz/oauth2/access_token';
...
Strategy.prototype.userProfile = function (accessToken, done) {
    ...
    this._oauth2.get('http://id.yoke.kz/oauth2/profile', accessToken, function (err, body, res) {
        if (err) {
